...
1. Используйте Windows 10/11. Начните с Python 3.12; если SherloCAN обнаружит несовместимость архитектуры J2534 DLL, установите Python 3.12 x86 и выполните `scripts\\setup_windows.bat x86`.
2. Установите Python 3.12. Не выбирайте разрядность OpenPort DLL наугад — ориентируйтесь на фактическую проверку приложения.
