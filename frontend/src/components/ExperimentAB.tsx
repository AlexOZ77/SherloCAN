...
export default function ExperimentAB({current}:{current:AtomicCaptureResult|null}){
 const [sessions,setSessions]=useState<Saved[]>([]),[comparison,setComparison]=useState<Comparison|null>(null),[divergence,setDivergence]=useState<Divergence|null>(null),[message,setMessage]=useState(""),[markerTime,setMarkerTime]=useState("");
